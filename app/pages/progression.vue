<template>
  <article class="progression-page">
    <header class="page-heading">
      ...
      <p>
        Matcha меняет привычный порядок развития. Этот маршрут проведёт от
        первого костра и меди до благословений, Энда и поздней игры.
      </p>
    </header>
    ...
    <section class="article-section">
      <header class="section-heading">
        ...
        <h2>Подсказки из игры</h2>
        <p>
          Достижения намекают на следующий шаг. Там, где формулировка загадочная,
          ниже есть понятное условие и ссылка на нужный предмет или раздел.
        </p>
      </header>
...
const stages = [
  ...
  },
  {
    ...
    summary: 'Лечебная еда, серебро, сталь, палатинатовая кирка с Шёлковым касанием и первые постоянные сердца.',
  ...
  },
  {
    ...
    summary: 'Эстус, бензол, Назар, божественные фрагменты и адамант до похода в Энд.',
    to: '/guides/nether',
    icon: PhCastleTurret,
  ...
  },
  {
    ...
    to: '/guides/endgame',
    icon: PhCrown,
    goals: ['Не тратить первую милость вслепую', 'Перейти к возобновляемым звёздам', 'Собрать устройства поздней игры']
  }
]
